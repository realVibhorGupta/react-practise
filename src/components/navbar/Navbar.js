	...
	return (
		<>
			<div className="hidden lg:block relative border-b mb-8 px-8 border-gray-100">
				<div className="2xl:container 2xl:mx-auto flex justify-between items-center w-full">
						...
						>
							...
							<button className="w-full mt-2 flex p-2 flex justify-start items-center space-x-2 hover:bg-blue-50 rounded">
								...
								<div className="flex justify-start items-start flex-col space-y-1">
									...
									<p className="text-xs text-left leading-3 text-gray-600">
							...
							<div className="px-3 flex justify-start items-start mt-10 flex-col space-y-4">
								<p className="text-sm text-left font-medium leading-4 text-gray-800">
									Flows
								</p>
								<p className="text-xs text-left leading-3 text-gray-600">
									Classes
					...
					<div className="flex justify-center items-center w-full space-x-4">
						<button className="py-3 h-full text-gray-600 focus:text-blue-700 text-center border-b-2 focus:outline-none focus:border-blue-700 border-transparent active:border-blue-700">
							<NavLink
								to="/"
								className={`first-letter: text-sm focus:outline-none font-medium leading-4 px-4 py-3 hover:bg-blue-50 hover:text-blue-700 rounded
								${isActive ? "bg-white text-gray-600" : "bg-blue-50 text-blue-700"}
								`}
							>
								Home
							</NavLink>
						</button>
						<button className="py-3 h-full text-gray-600 focus:text-blue-700 text-center bor	der-b-2 focus:outline-none focus:border-blue-700 border-transparent">
							<NavLink
								to="/contact"
					...
					<div className="relative py-3 flex justify-end items-center w-full space-x-6">
						...
						<button onclick="showDropdown()" className="rounded-full">
							<img src="https://i.ibb.co/MssyL01/Group-1788.png" alt="avatar" />
						</button>
						<div
							id="dropdown"
							className="hidden absolute z-20 top-20 w-80 bg-white shadow border rounded border-gray-200 py-4 flex justify-start items-start flex-col"
						>
							<div className="px-4 flex justify-start items-start space-x-4">
								<div>
									<img
										src="https://i.ibb.co/MssyL01/Group-1788.png"
										alt="avatar"
									/>
								</div>
							...
							<button className="px-4 mt-8 text-sm leading-3 text-gray-600">
								Sign Out
							</button>
						</div>
					</div>
			...
			<div className="lg:hidden h-full">
				<div className="py-4 px-4 md:px-6 w-full flex justify-between items-center bg-white border-b border-gray-100">
					<div
						id="searchItems"
						...
						<div className="flex jusitfy-end items-center space-x-10">
							...
							>
								...
								<div className="relative">
									<button onclick="show2('dropdown2')" className="w-8">
										<img
											className="w-8"
											src="https://i.ibb.co/MssyL01/Group-1788.png"
											alt="avatar"
									...
									<div
										id="dropdown2"
										className="hidden absolute z-20 top-16 -right-16 w-80 sm:w-96 bg-white shadow border rounded border-gray-200 py-4 flex justify-start items-start flex-col"
									>
										<div className="px-4 flex justify-start items-start space-x-4">
											<div>
												<img
										...
										<button className="mt-4 flex justify-start items-center text-gray-600 hover:bg-blue-50 focus:bg-blue-100 space-x-2 px-4 py-2 focus:outline-none hover:text-blue-700 focus:text-blue-700 w-full">
											<svg
												width="14"
												height="14"
												viewBox="0 0 14 14"
										...
										<button className="mt-2 flex justify-start items-center text-gray-600 hover:bg-blue-50 focus:bg-blue-100 space-x-2 px-4 py-2 focus:outline-none hover:text-blue-700 focus:text-blue-700 w-full">
											<svg
												width="14"
												height="14"
												viewBox="0 0 14 14"
					...
					>
						<div className="relative w-full flex justify-start items-center mr-4 md:mr-16">
							...
							>
								...
								<div className="px-3 flex justify-start items-start mt-8 flex-col space-y-4">
									<p className="text-base text-left font-medium leading-4 text-gray-800">
										Flows
									</p>
									<p className="text-base text-left leading-3 text-gray-600">
										Classes
									</p>
									<p className="text-base text-left leading-3 text-gray-600">
										Curriculum
				...
				>
					<div className="w-full sm:w-64 flex-col bg-white h-full flex justify-between items-start px-2 md:px-4 pb-4">
						...
						<div className="mt-96 w-full flex justify-end">
							<button className="p-3 focus:outline-none rounded text-xs font-medium leading-3 w-full text-blue-700 bg-blue-50 focus:bg-blue-700 focus:text-white text-gray-600">
								Upgrade Now
							</button>
						</div>
					</div>
