...
const AddAppointment = () => {
	...
	const formDataPublish = () =>{
		if (!setFormData)  setFormData(true)
		if (!toggleForm) setToggleForm(true)
	}
	return (
		<div>
				...
				<div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start  sm:pt-5">
					...
					<div className="mt-1 sm:mt-0 sm:col-span-2">
						<textarea id="aptNotes" name="aptNotes" rows="3"
							...
							className="w-full py-3 bg-gray-100 rounded pl-10 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block  sm:text-sm border-gray-300 " placeholder="Detailed comments about the condition"></textarea>
					</div>
				</div>
